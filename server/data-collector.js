...
class TradingDataCollector {
  ...
  // Collect real-time price and indicator data
  collectMarketData(data) {
    ...
    this.addToBuffer('priceData', marketDataPoint);
    this.addToBuffer('indicators', marketDataPoint.indicators);
    this.addToBuffer('marketConditions', marketDataPoint.marketConditions);
  }
